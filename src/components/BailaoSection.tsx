    ...
    <section id="bailao" className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="font-body text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Acontece toda sexta-feira.
        </p>
        <p className="font-body text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mt-2">
          Iniciamos com um almoço e começa o bailão, que vai até o fim do dia!
        </p>
      </div>
    </section>
  );
